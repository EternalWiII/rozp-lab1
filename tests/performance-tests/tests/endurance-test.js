...
import {DEFAULT_THRESHOLDS, SMOKE_THRESHOLDS} from '../config/endpoints.js';
import {
  checkHealth,
  createTravelPlan,
  getTravelPlan,
...
export const options = {
  stages: [
    { duration: '5m', target: 100 }, // Наростання
    { duration: '30m', target: 100 }, // Тривале навантаження(у практиці
  ...
  thresholds: {
    ...
    'http_req_duration': ['p(95)<500'], // Очікуємо швидку відповідь
